  ...
  return (
    <Box className="w-full p-4">
      <Flex align="center" justify="space-between" className="w-full" visibleFrom="lg">
        ...
        <Box className="h-0.5 w-full animate-step-2" style={{ background: theme.colors.primaryColor[9] }} />
        ...
        <Box className="h-0.5 w-full animate-step-3" style={{ background: theme.colors.primaryColor[9] }} />
      ...
      <Flex direction={{ base: "column", lg: "row" }} justify={{ lg: "space-between" }} mt="xl">
        <Box w={{ base: "100%", lg: "32%" }} mt={{ base: "xl", lg: 0 }} className="animate-step-1">
        ...
        <Box w={{ base: "100%", lg: "32%" }} mt={{ base: "xl", lg: 0 }} className="animate-step-2">
          <Card shadow="sm" p="lg" radius="md" withBorder>
            <Flex align="center" mb="md" hiddenFrom="lg">
              <Center className="w-10 h-10 rounded-full text-white font-bold" style={{ background: theme.colors.primaryColor[9] }}>2</Center>
            </Flex>
        ...
        <Box w={{ base: "100%", lg: "32%" }} mt={{ base: "xl", lg: 0 }} className="animate-step-3">
          <Card shadow="sm" p="lg" radius="md" withBorder>
            <Flex align="center" mb="md" hiddenFrom="lg">
              <Center className="w-10 h-10 rounded-full text-white font-bold" style={{ background: theme.colors.primaryColor[9] }}>3</Center>
            </Flex>
